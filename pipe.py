...
class Pipe(Sprite):
	...
	def __init__(self, Arena_Game):
		...
		#self.pipecover_image.midtop = self.pipe_image.midbottom
	...
	#def add_pipe_cover(self):
		#pygame.draw.rect(self.screen, self.settings.pipe_color, self.pipecover_image)