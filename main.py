...
class Arena_Game:
	...
	def create_pipes(self):
		...
		pipe_bottom_height = 640 - pipe_top_height - 85
		...
		pipe_bottom.pipe_image.y += 85 #memberikan jarak antara pipe_top dan pipe_bottom
		pipe_top.head.head_rect.midbottom = pipe_top.pipe_image.midbottom #set posisi head pipe_top
		pipe_bottom.head.head_rect.midtop = pipe_bottom.pipe_image.midtop #set posisi
